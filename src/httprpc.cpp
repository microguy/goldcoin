...
{
public:
    HTTPRPCTimer(struct event_base* eventBase, std::function<void(void)>& func, int64_t millis) :  // C++23 function
...
public:
    ...
    RPCTimerBase* NewTimer(std::function<void(void)>& func, int64_t millis)  // C++23 function
    {
